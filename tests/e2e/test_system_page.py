...
def test_system_page_shows_every_named_section(client: TestClient) -> None:
    ...
    # F11 (M5C-11), closed by MirrorWall 0.2.1: the wrap rule lives in components.css — the
    # page-level stopgap must be gone, not merely unnecessary.
    assert "overflow-wrap: anywhere" not in text
